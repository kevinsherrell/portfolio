...
class App extends Component {
    ...
    handleScroll = (e) => {
        ...
        // let fixed = this.pageHeader.offsetTop
        ...
        return (
            <React.Fragment>
                <div style={backgroundStyles} className='backgroundContainer'>
                    <header className="pageHeader" ref={header => this.pageHeader = header} onClick={this.onClickHeader}>
                        <div className='container flex'>
                            ...
                            <nav>
                                ...
                                <button className='hamburgerButton' ref={button => this.hamburgerButton = button}>
                    ...
                    <section style={{ backgroundAttachment: 'fixed' }} className="hero">
                        <div className='container'>
                            <div className='heroContainer'>
                                ...
                                <h2 className='heroSubTitle'>Full Stack <span>Javascript</span> Developer</h2>
                ...
                <section className="projects">
                    ...
                    <div className='projectDescription'>project 1 description</div>
                    <div className='project'>
                        <img src={notFacebookImage} alt="" />
                    </div>
                    <div className='projectDescription'>project 2 description</div>
                    <div className='project'>
                        <img src={notFacebookImage} alt="" />
                    </div>
                    <div className='projectDescription'>project 3 description</div>
                    <div className='project'>
                        <img src={notFacebookImage} alt="" />
                    </div>
                    <div className='projectDescription'>project 4 description</div>
                </section>
                <section className="skills">
                    ...
                    {/* mobile only */}
                    <h3>About Me</h3>
                    <p className='aboutMe'>I am a full stack Javascript developer based in the greater St. Louis, MO metropolitan area. I love to learn new things and I am always challenging myself. <span>Currently I am proficient in the following tehcnologies:</span>  </p>
                    ...
                    <div className='skillsListNonMobile '>
                        ...
                        <div className="otherSkills"><h4>Other Notable Skills : </h4>
                            <ul>
                ...
                <section className='contact'>
                    <div className="container">
                        <p className='thankYou'><span>Thanks for viewing my portfolio.</span> If you would like to get in contact with me about job opportunities or just general feedback on my code, my info is below!</p>
